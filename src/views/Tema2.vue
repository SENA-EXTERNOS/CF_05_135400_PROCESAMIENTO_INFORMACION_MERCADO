  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5P
    ...
    .bloque-texto-d.color-secundario.p-4
        .bloque-texto-d__texto.mb-2
          i.fas.fa-quote-left
          h3.text-regular Según el artículo ‘Metodología de la Investigación en las ciencias sociales’(Escuela de Administración de Negocios, 2008) establece que:
    ...
    .row.d-flex.justify-content-center.align-items-center.mt-5
      .col-8
        ImagenInfografica.color-secundario.mb-5
          ...
          .tarjeta.color-acento-botones.p-3(x="12%" y="1%" numero="1")
            p Encuestas de preguntas abiertas
          .tarjeta.color-acento-botones.p-3(x="37%" y="1%" numero="2")
            p Observación cualitativa
          .tarjeta.color-acento-botones.p-3(x="63%" y="1%" numero="3")
            p Técnica Delphi
          .tarjeta.color-acento-botones.p-3(x="88%" y="1%" numero="4")
            p Entrevista
          .tarjeta.color-acento-botones.p-3(x="25%" y="54%" numero="5")
            p Documentales
          .tarjeta.color-acento-botones.p-3(x="50%" y="54%" numero="6")
            p Focus Groups
          .tarjeta.color-acento-botones.p-3(x="75%" y="54%" numero="7")
